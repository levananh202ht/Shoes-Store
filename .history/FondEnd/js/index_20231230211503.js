...
const listNavBar = document.querySelector(".container_header-navbar li ")

const iconBar = document.querySelector(".container_header-bar .fa-bars")
const iconClose = document.querySelector(".container_header-bar .fa-times")
